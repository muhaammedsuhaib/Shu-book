...
function Collect() {
  ...
  const clickHandle = async (e) => {
    ...
    try {
      await axios.post(
        `https://shubook-backend-project.onrender.com/api/${userData.id}/add`,
        {
      ...
      <MDBRow>
        ...
        >
          ...
          <p className="fs-5 text" style={{ color: "hsl(218, 81%, 85%)" }}>
            Welcome back, [UserName]! Stay organized and boost your productivity
            with SHUBOOK's intuitive to-do list features
          </p>
        </MDBCol>
            ...
            <MDBCardBody className="p-5">
              <form onSubmit={clickHandle}>
                ...
                <MDBBtn
                  type="submit"
                  block
                  style={{ background: "hsl(218, 81%, 70%)", color: "black" }}
                >
                  Add Task
                </MDBBtn>
