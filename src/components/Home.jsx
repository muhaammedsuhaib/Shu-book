...
const Home = () => {
  ...
  return (
    <div className="container-fluid w-100 p-0" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <div className="container p-4" style={{ display: 'grid', placeItems: 'center' }}>
        ...
        <div className="container text-center">
          <MDBBtn variant="primary" rounded className="btn btn-lg btn-primary text-center" onClick={() => nav(!userData ? '/login' : '/blog')}>
            <img src="/button-logo.png" alt="Logo" style={{ width: '34px' }} />
            Get Started
          </MDBBtn>
        </div>
      </div>
